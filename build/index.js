...
/***/ "./src/components/counter-list.js":
/*!****************************************!*\
  !*** ./src/components/counter-list.js ***!
  \****************************************/
...
const Counter = ({
  ...
  const value = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["useSelect"])(select => select('react-example/counters').getCounterValue(counterId));
  const {
    removeCounter,
    setCounterValue
...
/* harmony import */ var _components_counter_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/counter-list */ "./src/components/counter-list.js");
...
/*!******************************!*\
  !*** ./src/store/actions.js ***!
  \******************************/
/*! exports provided: addCounter, removeCounter, setCounterValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addCounter", function() { return addCounter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeCounter", function() { return removeCounter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setCounterValue", function() { return setCounterValue; });
...
Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["registerStore"])('react-example/counters', {
...
function reducer(state = [], action) {
  switch (action.type) {
    ...
    case 'REMOVE_COUNTER':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["without"])(state, Object(lodash__WEBPACK_IMPORTED_MODULE_0__["find"])(state, {
        id: action.counterId
      }));

    case 'SET_COUNTER_VALUE':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["map"])(state, counter => counter.id === action.counterId ? { ...counter,
        value: action.value
      } : counter);
  }
...
/*!********************************!*\
  !*** ./src/store/selectors.js ***!
  \********************************/
/*! exports provided: getCounterIds, getCounterValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCounterIds", function() { return getCounterIds; });
...
function getCounterIds(state) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["map"])(state, 'id');
}
function getCounterValue(state, counterId) {
  const counter = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["find"])(state, {
    id: counterId
  }) || {};
